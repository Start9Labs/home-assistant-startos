...
This repo packages [Home Assistant](https://www.home-assistant.io/) for StartOS.
...
Home Assistant runs the upstream `ghcr.io/home-assistant/home-assistant` image, pinned to a specific tag in the manifest. To track a new upstream release:

1. Bump `dockerTag` in `startos/manifest/index.ts` to `ghcr.io/home-assistant/home-assistant:<new version>`.
